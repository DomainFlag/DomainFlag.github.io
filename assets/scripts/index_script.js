...
/* Summary Search */
var content_summary_search = document.querySelector(".searching-grid-container");
var content_search_body = document.querySelector(".searching-option-template");
...
var content_JSON = [
    ...
    [
        {
            'content-header': 'THE DOCUMENT OBJECT MODEL',
            'content-body': [
                {
                    'content-body-title': 'Moving through the Tree',
                    'content-body-info': '',
                    'content-body-snippet': 'parentNode & childNodes, firstChild & lastChild, previousSibling & nextSibling'
                }, {
                    'content-body-title': 'Finding Elements',
                    'content-body-info': '',
                    'content-body-snippet': 'getElementByTagName & getElementById & getElementByClassName & querySelector'
                }, {
                    'content-body-title': 'Changing the Document',
                    'content-body-info': '',
                    'content-body-snippet': 'removeChild & appendChild & insertBefore & replaceChild'
                }, {
                    'content-body-title': 'Creating Nodes',
                    'content-body-info': '',
                    'content-body-snippet': 'createTextNode & createElement'
                }, {
                    'content-body-title': 'Attributes',
                    'content-body-info': '',
                    'content-body-snippet': 'getAttribute & setAttribute'
                }, {
                    'content-body-title': 'Layout',
                    'content-body-info': '',
                    'content-body-snippet': 'offsetWidth & offsetHeight, clientWidth & clientHeight, getBoundingClientRect, pageXOffset & pageYOffset'
                }
            ]
        }, {
            'content-header': 'HANDLING EVENTS',
            'content-body': [
                {
                    'content-body-title': 'Event Handlers Methods',
                    'content-body-info': '',
                    'content-body-snippet': 'addEventListener & removeEventListener'
                }, {
                    'content-body-title': 'Event Objects',
                    'content-body-info': '',
                    'content-body-snippet': 'Event handlers passes an argument:event -> which/target/... properties'
                }, {
                    'content-body-title': 'Propagation',
                    'content-body-info': '',
                    'content-body-snippet': 'Parent\'s children receives children\'s events by propagation. event.stopPropagation();'
                }, {
                    'content-body-title': 'Default Actions',
                    'content-body-info': '',
                    'content-body-snippet': 'Use event.preventDefault(); to prevent default events.'
                }, {
                    'content-body-title': 'Key Events',
                    'content-body-info': '',
                    'content-body-snippet': 'keypress & keydown & keyup'
                }, {
                    'content-body-title': 'Mouse Clicks',
                    'content-body-info': '',
                    'content-body-snippet': 'mousedown & mouseup & click & dblclick'
                }, {
                    'content-body-title': 'Mouse Motion',
                    'content-body-info': '',
                    'content-body-snippet': 'mouseover & mouseout'
                }, {
                    'content-body-title': 'Scroll Events',
                    'content-body-info': '',
                    'content-body-snippet': 'scroll'
                }, {
                    'content-body-title': 'Focus Events',
                    'content-body-info': '',
                    'content-body-snippet': 'focus & blur'
                }, {
                    'content-body-title': 'Load Events',
                    'content-body-info': '',
                    'content-body-snippet': 'load & beforeunload'
                }
            ]
        }, {
            'content-header': 'TIME',
            'content-body': [
                {
                    'content-body-title': 'Script Executing Timeline',
                    'content-body-info': '',
                    'content-body-snippet': 'var worker = new Worker("script.js");'
                }, {
                    'content-body-title': 'Setting Timers',
                    'content-body-info': '',
                    'content-body-snippet': 'setTimeout & setInterval function'
                }, {
                    'content-body-title': 'Debouncing Effect',
                    'content-body-info': '',
                    'content-body-snippet': 'Delay the rapid style events with timers to avoid heavy power consuming tasks'
                }
            ]
        }, {
            'content-header': 'CANVAS',
            'content-body': [
                {
                    'content-body-title': 'The Canvas Element',
                    'content-body-info': '',
                    'content-body-snippet': 'var context = document.querySelector("canvas").getContext("2d");'
                }, {
                    'content-body-title': 'Filling & Stroking',
                    'content-body-info': '',
                    'content-body-snippet': 'fillRect & strokeRect & fillStyle & lineWidth'
                }, {
                    'content-body-title': 'Paths',
                    'content-body-info': '',
                    'content-body-snippet': 'beginPath & stroke method | moveTo & lineTo | fill and closePath'
                }, {
                    'content-body-title': 'Curves',
                    'content-body-info': '',
                    'content-body-snippet': 'quadraticCurveTo & arcTo | arc methods'
                }, {
                    'content-body-title': 'Text',
                    'content-body-info': '',
                    'content-body-snippet': 'fillText | size, style font methods'
                }, {
                    'content-body-title': 'Images',
                    'content-body-info': '',
                    'content-body-snippet': 'Create image ele, path with src(load it) and drawImage for rendering'
                }, {
                    'content-body-title': 'Storing and Clearing Transformations',
                    'content-body-info': '',
                    'content-body-snippet': 'save & restore methods'
                }
            ]
        }, {
            'content-header': 'HTTP',
            'content-body': [
                {
                    'content-body-title': 'HTTP request types',
                    'content-body-info': '',
                    'content-body-snippet': 'GET POST PUT DELETE'
                }, {
                    'content-body-title': 'URL encoding',
                    'content-body-info': '',
                    'content-body-snippet': 'encodeURIComponent & decodeURIComponent'
                }, {
                    'content-body-title': 'Sending Requests',
                    'content-body-info': '',
                    'content-body-snippet': 'new XMLHttpRequest(); -> open method -> load event -> send event'
                }, {
                    'content-body-title': 'Receiving Requests',
                    'content-body-info': '',
                    'content-body-snippet': 'load event with getting data via responseText property'
                }
            ]
        }, {
            'content-header': 'FORMS AND FORM FIELDS',
            'content-body': [
                {
                    'content-body-title': 'Focus',
                    'content-body-info': '',
                    'content-body-snippet': 'focus & blur method for input'
                }, {
                    'content-body-title': 'Form element',
                    'content-body-info': '',
                    'content-body-snippet': 'querySelector form ->elements -> (input type)'
                }, {
                    'content-body-title': 'Text Fields',
                    'content-body-info': '',
                    'content-body-snippet': 'textarea and input -> value property | input event'
                }, {
                    'content-body-title': 'Checkboxes and Radio Buttons',
                    'content-body-info': '',
                    'content-body-snippet': 'checked property'
                }, {
                    'content-body-title': 'Select Fields',
                    'content-body-info': '',
                    'content-body-snippet': 'selected property'
                }, {
                    'content-body-title': 'File Fields',
                    'content-body-info': '',
                    'content-body-snippet': 'files, name, size, type property & FileReader object with readAsText method and result property'
                }, {
                    'content-body-title': 'Storing Data Client-Side',
                    'content-body-info': '',
                    'content-body-snippet': 'Store/Get/Remove in localStorage public object with setItem | getItem | removeItem method'
                }
            ]
        }
    ],
...
function updatePage(content) {
    ...
    for (var i = 0; i < content.length; i++) {
        ...
        cloneHeader.id = contentBody["content-header"];
...
function updateSummarySearch(content) {

    while(content_summary_search.firstChild) {
        content_summary_search.removeChild(content_summary_search.firstChild);
    }

    content.forEach(function(header) {
        var cloneNode = content_search_body.cloneNode(true);
        cloneNode.textContent = header["content-header"];
        cloneNode.style.display = "initial";
        cloneNode.href = "#" + header["content-header"];
        content_summary_search.appendChild(cloneNode);
    })
}
